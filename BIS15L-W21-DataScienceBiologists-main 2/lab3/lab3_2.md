...
```r
#Hints that order and family are categorical data sets. Maybe not values like mass though.
```
...
```r
#Says 161 Artiodactyla, 197 Carnivora, etc.
```
...
#Can do this, but have a TON of data to the point where it surpasses print number. Not super useful, there will be better ways to do this.
```
