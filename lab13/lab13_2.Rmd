...
Have session present in server <- function, and also have line "session$onSessionEnded(stopApp)", which will stop the app. Very handy single line of code that you can add to your app. BUT make sure the session part is present, or else the whole app won't work.

Sliderinput to userinput to allow users to control font size. Font size is part of a theme. Make sure you call it in theme!
